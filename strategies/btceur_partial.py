"""
BTCEUR Partial Close Strategy

Entrada: idéntica a BTCEURStrategy (btceur_simple).
...
class BTCEURPartialStrategy(BTCEURStrategy):
    """
    BTCEUR v1.1 — Partial Close.

    Promoted to production after LastEdge Exit Research validation.
    La lógica de entrada permanece idéntica a btceur_simple.
    ...
    def __init__(self):
        super().__init__()
        self.strategy_name = "BTCEUR_Partial"
    ...
    def detect_setup(self, df: pd.DataFrame, config: Dict = None) -> Optional[Dict]:
        ...
        signal['context']['strategy'] = 'btceur_partial'
